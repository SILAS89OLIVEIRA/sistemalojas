...
(function ($, window, document, undefined) {
    ...
    $.fn.twbsPagination.defaults = {
        ...
        nextClass: 'next waves-effect page-link',
        prevClass: 'prev waves-effect page-link',
        lastClass: 'last waves-effect page-link',
        firstClass: 'first waves-effect page-link',
        pageClass: 'page waves-effect page-link',
        activeClass: 'active',
