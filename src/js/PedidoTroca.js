...
function Chamada(id, urll, data_escolhida) {
    ...
    $h.ajax({
        ...
        success: function (html) {
            ...
            sql = sql + ('<table id="tablePedido" class="table striped"><thead class=\"bg-primary darken-1 text-white\"><tr class="success"><th></th><th>CPF/CNPJ</th><th>CLIENTE DOCUMENTO</th><th> PEDIDOS</th><th>TROCAS</th><th>TOTAL</th></tr></thead>');
            //console.log(urll);
            cont = 1;
            cont2 = 1;
...
function ChamadaVend(id, urll) {
    ...
    $h.ajax({
        ...
        success: function (html) {
            ...
            var sql = "";
            //fat.append('<table class="table table-bordered table-hover table-striped"><thead><tr><th>CpfCnpj</th><th>Cliente</th><th>Valor Pedidos</th><th>Valor Trocas</th><th>Valor Total</th></tr></thead>');
            sql = sql + ('<table id="tabelatroca1" class="table striped"><thead class=\"bg-primary darken-1 text-white\"><tr class="success"><th></th><th>VENDEDOR</th><th>PEDIDO</th><th> TROCA</th><th>TOTAL</th></tr></thead>');
            console.log(urll);
            cont = 1;
            cont2 = 1;
            $h.each(html, function (key, value) {
