                ...
                onPageClick: function (event, page) {
                    ...
                    $.ajax({
                        ...
                        success: function (data)
                        {
                            ...
                            //data = data.data;
                            sql = sql + ('<table class="responsive-table table bordered highlight input-sm striped"><thead class=\"blue darken-1 white-text\"><tr><th></th><th>FORNECEDOR</th><th>PRODUTO</th><th>REF.</th><th>TAMANHO</th><th>PÁG.</th><th>ESTQ.LOJA</th><th>PREÇO</th><th>QTD.LOGÍSTICA</th></tr></thead>');
