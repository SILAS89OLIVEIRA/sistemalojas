...
function consultaInsert(tipo){
    ...
    var caipag_data_caixa = $("#databusca").val();
    var observacao = $("#observacao1").val();
    ...
    $.ajax({
        ...
        success: function (html) {
            ...
            $.each(html, function (key, value) {
             ...
             $("#observacao1").html(html[0].caiobs_observacao);
...
$("#desconto").click(function () {
    ...
    if (descontocheck === true) {
        ...
        $("#Percentual").val(5);
        $("#ValorFinal").val(tratarValor(((caipag_valor_total / 100) * 5)));
...
$("#acrescimo").click(function () {
    ...
    if (acrescimocheck === true) {
        ...
        $("#PercentualA").show();
        $("#ValorFinalA").show();
        $("#LabelValorFinalA").show();
        $("#LabelPercentualA").show();
        $("#LabelPercentualA").show();
        $("#PercentualA").val(5);
         var percentualacrescimo = $("#PercentualA").val();
          console.log(percentualacrescimo);
        $("#ValorFinalA").val(tratarValor((((caipag_valor_total / 100) *(percentualacrescimo)))));
...
$("#btnsalvarpag").click(function () {
    ...
    var caipag_fab_defeito = $("#defeito").val();
    ...
    if (descontocheck == true) {
        //desconto = parseFloat((((parseFloat(($('#ValorFinal').val()))*100))/parseFloat(caipag_valor))); 
		desconto = 5; 
    }
 ...
 // alert(caipag_valor);
    ...
    $("#descontovalor").val(''); $("#acrescimovalor").val('');
    } else {
...
var cpfcnpjcartao1 = $("#cpfcnpjcartao1").val();


    var acrescimovalor = 0;
            
            if (acrescimocheck === true) {     
            acrescimovalor =  $('#ValorFinalA').val();
  ...
  $.ajax({
    ...
    $.ajax({
        ...
        success: function (html) {
            ...
            $('#defeito').html(comboxfornecedordefeito("defeito", html, "", ""));
            $g('#loading').modal('close');
...
function hideAllFormPagamento() {
 ...
 $("#LabelValorFinalA").hide();
  $("#LabelPercentualA").hide();
    ...
    $("#form-group-cpfcnpjcartao").hide();
    $("#cpfcnpjcartao").hide();
    $("#cpfcnpjcartao1").hide();  
    $("#form-group-bandeira").hide();
    $("#form-group-for-defeito").hide();
    $("#defeito").hide();
