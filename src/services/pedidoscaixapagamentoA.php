...
switch ($_SERVER['REQUEST_METHOD']) {
    case 'GET':
        ...
        insertPagamento($forpag_cod, $caipag_cpfcnpj, $caipag_data_caixa, $caipag_valor, $caipag_valor_total, $caipag_num_autorizacao, $caipag_parcelas, $bancar_cod, 
                $caipag_cod_fornecedor, $desconto, $caipag_loja_parceira, $caipag_nomeclie, $loj_num, $caipag_express,$caipag_datacartao,$caipag_horacartao,$caipag_frete,$desconto_valor,$loja_parceira_cartao);
        break;
}

function insertPagamento($forpag_cod, $caipag_cpfcnpj, $caipag_data_caixa, $caipag_valor, $caipag_valor_total, $caipag_num_autorizacao, $caipag_parcelas, $bancar_cod, 
        $caipag_cod_fornecedor, $desconto, $caipag_loja_parceira, $caipag_nomeclie, $loj_num, $caipag_express,$caipag_datacartao,$caipag_horacartao,$caipag_frete,$desconto_valor,$loja_parceira_cartao) {
...
caipag_valor, caipag_valor_total, caipag_num_autorizacao, caipag_parcelas, "
			...
			caipag_data_cartao, caipag_hora_cartao,caipag_frete,caipag_valor_desconto,caipag_loja_parceira_cartao) VALUES (" . $forpag_cod . ", '" . $caipag_cpfcnpj . "','" . $caipag_data_caixa . "', "
            . "" . $caipag_valor . ", " . $caipag_valor_total . ", '" . $caipag_num_autorizacao . "', " .
 $caipag_parcelas . "," . $bancar_cod . ", " . $caipag_cod_fornecedor . ", " . $desconto . ", '" . 
$caipag_loja_parceira . "' , '" . $caipag_nomeclie . "' , 0, NOW(), NOW(), " . $loj_num . ", " . $caipag_express . "". ", '" . $caipag_datacartao . "' , '" . $caipag_horacartao . "', ".$caipag_frete.",".$desconto_valor.", ".$loja_parceira_cartao.")";
