...

{
	...
	$conexao = getConn();
$sql = "SELECT distinct trocas.documento,  trocas.data,  trocas.hora, codigovend, 
doctoclie, nomeclie, totaldesc, totalacre, totalitens, totalgeral,  trocas.operador, 
cancelado, alteracoes, bloqueado, vendedores.nome FROM trocas inner join itrocas on itrocas.documento = trocas.documento inner join vendedores on  vendedores.numero = codigovend  ";


$sqlWhere = "where trocas.data>=':datini' and trocas.data<=':datfim' ";
